...
//                           key={idx}
//                           variant="secondary"
//                           className="text-xs bg-blue-300 text-primary border-primary/20"
//                         >
//                           {feature}
//                         </Badge>
//                       ))}
    ...
    <section className="py-16 lg:py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            From outdoor advertising to digital marketing and beyond, we offer
            diversified services to meet all your business needs under one roof.
          </p>
        </div>
            ...
            return (
              ...
              >
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-xl font-bold text-blackish group-hover:text-blue-500 transition-colors">
                    {service.name}
                  </CardTitle>
                </CardHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <h4 className="font-semibold text-sm text-blackish">
                      Key Features:
                    </h4>
                    <div className="flex flex-wrap gap-2">
                      {service.features.slice(0, 2).map((feature, idx) => (
                  ...
                  {/* Fixed Button with always visible text */}
                  <Button
                    asChild
                    variant="ghost"
                    className="w-full justify-between transition-colors bg-gray-50 text-blackish hover:bg-gradient-to-r hover:from-sky-400 hover:to-blue-600 hover:text-white"
                  >
                    <Link
